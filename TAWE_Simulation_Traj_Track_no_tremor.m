%% The Wearable Wrist Exoskeleton (TAWE) trajectory tracking with MPC, no tremor (Figs 4,5)
...
% This script contains the simulation code for the wearable wrist exoskeleton
...
for ii=1:numel(tSpan1)
    ...
    X_in = [simStateVal(1:2);simStateVal(10:11)];       %Start point
...
save(strcat('./Data/tawe_traj_track_no_trem'),'simStateData') % Save result
save(strcat('./Data/tawe_traj_track_no_trem_inp'),'simInputData')
